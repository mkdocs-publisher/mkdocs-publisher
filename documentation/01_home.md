...
- automatic documents navigation creation ([pub-meta](02_setup/02_setting-up-meta.md) plugin - :material-plus-circle: [v0.6.0](04_blog/v060-obsidian.md)),
- documents publication status with additional meta-data like URL names, etc. beneficial for SEO ([pub-meta](02_setup/02_setting-up-meta.md) plugin - :material-plus-circle: [v0.6.0](04_blog/v060-obsidian.md)),
- integration with [Obsidian.md](https://obsidian.md/) as documentation editor with support for some Markdown syntax specific to it and some plugins ([pub-obsidian](02_setup/05_setting-up-obsidian.md) plugin :material-plus-circle: [v0.6.0](04_blog/v060-obsidian.md)):
